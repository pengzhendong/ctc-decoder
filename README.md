...
SenseVoiceSmall 的解码对比；每格为“不开热词 / 开热词”。IS21 的
`100/500/1000/2000` 表示每条音频的候选热词列表目标规模，不是音频数量。

| 数据集 | 候选热词规模 | 错误率 | 热词召回 | 热词精度 | F1 |
| --- | ---: | --- | --- | --- | --- |
| SeACo test | - | CER 10.41% / 8.40% | 51.59% / 77.28% | 99.39% / 99.18% | 67.92% / 86.87% |
| IS21 clean | 100 | WER 3.92% / 3.48% | 83.54% / 87.40% | 99.83% / 99.84% | 90.96% / 93.21% |
| IS21 clean | 500 | WER 3.92% / 3.48% | 83.54% / 87.40% | 99.83% / 99.16% | 90.96% / 92.91% |
| IS21 clean | 1000 | WER 3.92% / 3.49% | 83.54% / 87.32% | 99.83% / 98.18% | 90.96% / 92.43% |
| IS21 clean | 2000 | WER 3.92% / 3.51% | 83.54% / 87.25% | 99.83% / 96.84% | 90.96% / 91.79% |
| IS21 other | 100 | WER 8.22% / 7.55% | 68.06% / 74.39% | 99.72% / 99.69% | 80.91% / 85.20% |
| IS21 other | 500 | WER 8.22% / 7.56% | 68.06% / 74.39% | 99.72% / 98.44% | 80.91% / 84.74% |
| IS21 other | 1000 | WER 8.22% / 7.57% | 68.06% / 74.31% | 99.72% / 96.87% | 80.91% / 84.11% |
| IS21 other | 2000 | WER 8.22% / 7.61% | 68.06% / 74.26% | 99.72% / 94.56% | 80.91% / 83.19% |
| Earnings-22 test | - | WER 25.10% / 24.98% | 24.87% / 26.97% | 98.57% / 98.68% | 39.72% / 42.36% |
